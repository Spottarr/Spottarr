...
public class SpotnetHeaderParserTests
{
    ...
    public void ParsesHeaderValidVariant1(string subjectAndTags)
    {
        ...
        Assert.Equal(
            "pizlw58KFSC94SUdwAIMBzRNxmCZrhEnZb4ihCLAX9p6ViN9s2vf-pwFFZqPKwzFF",
            result.UserModulus
        );
        Assert.Equal(
            "dpeyw-ssEYgAUebInWNwvjKu6irDwuJCTpgDL7Y1k6lBQj1j4YE-sl99LqQ-sjg7fUf",
        ...
        Assert.Equal(
            "OmepU20o1i7VxNRhQkAxC1MU8UH4fuOy-pmcHCSgOyCv71Qi-pKuuyPFADcZSY2JqI",
    ...
    public void ParsesHeaderValidVariant2()
    {
        ...
        Assert.Equal(
            "7oGXyqZiTFIad-sLhInYOEcYylEmweUvnYF8CapS5S5hH12pdjwdLpd05fweJAHP5",
            result.UserModulus
        );
        Assert.Equal(
            "U8c7LC-sA-sq2-sw0yjuY-s-sDj1bncqGmFVlaQy3UtQyw65WkWdMEf8i3g7ImuVTS1-pc",
            result.UserSignature
        );
        Assert.Equal(1, result.Category);
        ...
        Assert.Equal("NL", result.CustomValue);
        Assert.Equal(
            "rV-sGFAvYDLhOVSllN173n2ZbEbq0rkSm9ku9j5CDmSQwKVj0kP-ph8CzB4L2PcEfr",
            result.ServerSignature
        );
    }
