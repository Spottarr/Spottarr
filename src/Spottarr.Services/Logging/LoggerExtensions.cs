...
public static partial class LoggerExtensions
{
    [LoggerMessage(
        ...
        Message = "Could not retrieve spot group '{SpotGroup}'."
    )]
    public static partial void CouldNotRetrieveSpotGroup(
        this ILogger logger,
        Exception exception,
        string spotGroup
    );
    ...
    public static partial void CouldNotRetrieveArticleHeaders(
        this ILogger logger,
        long from,
        long? to,
        int code,
    ...
    [LoggerMessage(
        Level = LogLevel.Error,
        Message = "Could not retrieve articles for [{From}-{To}]."
    )]
    public static partial void CouldNotRetrieveArticleHeaders(
        this ILogger logger,
        Exception exception,
    ...
    public static partial void CouldNotRetrieveDateHeader(
        this ILogger logger,
        long articleNumber,
        int code,
        string message
    ...
    [LoggerMessage(
        ...
        Message = "Found {ArticleNumber} with {ArticleDate} in [{From}-{To}] as closest match for {RetrieveAfterDate} in {Attempts} attempts."
    )]
    public static partial void FoundArticleNumberForRetrieveAfter(
        this ILogger logger,
        long articleNumber,
        DateTimeOffset? articleDate,
        long from,
        long to,
        DateTimeOffset retrieveAfterDate,
        int attempts
    );

    [LoggerMessage(
        Level = LogLevel.Error,
        Message = "Could not parse date header for [{ArticleNumber}]: '{Error}'."
    )]
    public static partial void CouldNotParseDateHeader(
        this ILogger logger,
        long articleNumber,
        string error
    );
    ...
    public static partial void CouldNotRetrieveArticle(
        this ILogger logger,
        Exception exception,
        string messageId
    );
    ...
    public static partial void FailedToParseSpotHeader(
        this ILogger logger,
        string messageId,
        string header
    );
    ...
    [LoggerMessage(
        Level = LogLevel.Debug,
        Message = "Article [{MessageId}] is missing spot XML header.'"
    )]
    ...
    public static partial void ArticleContainsInvalidSpotXmlHeader(
        this ILogger logger,
        string messageId,
        string xml
    );
    ...
    public static partial void SpotImportBatchStarted(
        this ILogger logger,
        int current,
        int total,
    ...
    public static partial void SpotImportBatchFinished(
        this ILogger logger,
        int current,
        int total,
        DateTimeOffset dateTime,
    ...
    [LoggerMessage(
        Level = LogLevel.Information,
        Message = "Bulk insert / update progress {Percentage}%"
    )]
    ...
    public static partial void ReachedRetrieveAfter(
        this ILogger logger,
    ...
    public static partial void SpotCleanupStarted(
        this ILogger logger,
        DateTimeOffset dateTime,
    ...
    [LoggerMessage(
        Level = LogLevel.Information,
        Message = "Spot cleanup finished at {DateTime}. Cleaned up {RowCount} spots, {FtsRowCount} full text index records."
    )]
    public static partial void SpotCleanupFinished(
        this ILogger logger,
        DateTimeOffset dateTime,
        int rowCount,
        int ftsRowCount
