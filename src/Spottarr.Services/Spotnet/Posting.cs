...
public sealed class Posting
{
    ...
    [XmlElement(ElementName = "Poster")] public string Poster { get; set; } = "";
    [XmlElement(ElementName = "Title")] public string Title { get; set; } = "";

    [XmlElement(ElementName = "Description")]
    public string Description { get; set; } = "";

    [XmlElement(ElementName = "Tag")] public string Tag { get; set; } = "";
    [XmlElement(ElementName = "Website")] public string Website { get; set; } = "";
