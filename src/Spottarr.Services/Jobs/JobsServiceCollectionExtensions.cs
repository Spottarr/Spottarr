...
{
    public static IServiceCollection AddSpottarrJobs(
        ...
        services
            .AddQuartz(c =>
            {
                ...
                c.ScheduleJob<ImportSpotsJob>(
                    JobKeys.ImportSpots,
                    config.ImportSpotsSchedule,
                    start
                );
                c.ScheduleJob<CleanUpSpotsJob>(
                    JobKeys.CleanUpSpots,
                    config.CleanUpSpotsSchedule,
                    start
                );
            })
