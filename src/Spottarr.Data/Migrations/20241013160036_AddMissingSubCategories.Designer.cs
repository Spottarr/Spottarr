...
namespace Spottarr.Data.Migrations
{
    ...
    [Migration("20241013160036_AddMissingSubCategories")]
    partial class AddMissingSubCategories
    {
        /// <inheritdoc />
                    ...
                    b.ToTable("Spots", t =>
                        {
                            ...
                            t.Property("Types")
                                .HasColumnName("ApplicationSpot_Types");
                        });
            ...
            modelBuilder.Entity("Spottarr.Data.Entities.GameSpot", b =>
                {
                    ...
                    b.ToTable("Spots", t =>
                        {
                            t.Property("Formats")
                                .HasColumnName("GameSpot_Formats");

                            t.Property("Genres")
                                .HasColumnName("GameSpot_Genres");

                            t.Property("Types")
                                .HasColumnName("GameSpot_Types");
                        });
